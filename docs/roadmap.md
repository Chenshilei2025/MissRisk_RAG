...
1. Implement MMDocRAG pilot conversion.
2. Implement ObservationAction generation from missing channels.
3. Add tiny synthetic fixtures so tests can validate the data pipeline without
